              ...
              <div className="p-4 sm:p-7.5">
                <div className="flex flex-col gap-4">
                  <p className="flex items-center gap-4">
                    ...
                    Name: Gulshan-e-Iqbal, Main Branch — 0340-0478111
                  </p>
                  ...
                  <p className="flex items-center gap-4">
                    ...
                    Phone: Defense Badar Commercial Ph5 — 0332-2737911
                  </p>
                  ...
                  <p className="flex gap-4">
                    ...
                    Address: Light House Branch — 0343-3485589
                  </p>
                </div>

                <p className="text-custom-sm text-dark-4 mt-5 border-t border-gray-3 pt-4 leading-6">
                  All-Pakistan Delivery &amp; Order:{" "}
                  <span className="font-medium text-dark">0332-2737911</span>
                  <br />
                  Email: <span className="font-medium text-dark">info@cronaldosports.pk</span>
                  <br />
                  Open Daily: <span className="font-medium text-dark">10:00 AM – 9:00 PM</span>
                </p>
              </div>
            </div>
