        ...
        <div className="w-full max-w-[1100px] rounded-xl shadow-3 bg-white p-4 sm:p-7.5 relative modal-content">
          ...
          <div className="flex flex-wrap items-center gap-12.5">
            ...
            <div className="max-w-[445px] w-full">
              ...
              <p>
                Genuine quality football gear from C.Ronaldo Sports — available
                at all three Karachi branches and delivered all over Pakistan.
              </p>
                ...
                <div>
                  ...
                  <span className="flex items-center gap-2">
                    <span className="font-semibold text-dark text-xl xl:text-heading-4">
                      Rs. {product.discountedPrice.toLocaleString("en-PK")}
                    </span>
