...
const ShopDetails = () => {
  ...
  useEffect(() => {
    try {
      const saved = window.localStorage.getItem("productDetails");
      if (saved) {
                ...
                <div className="max-w-[539px] w-full">
                  ...
                  <h3 className="font-medium text-custom-1 mb-4.5">
                    <span className="text-sm sm:text-base text-dark">
                      Price: Rs. {product.discountedPrice.toLocaleString("en-PK")}
                    </span>
                  ...
                  <form onSubmit={(e) => e.preventDefault()}>
                    <div className="flex flex-col gap-4.5 border-y border-gray-3 mt-7.5 mb-9 py-9">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="min-w-[65px]">
                          <h4 className="font-medium text-dark">Style:</h4>
                        </div>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="min-w-[65px]">
                          <h4 className="font-medium text-dark">Fit:</h4>
                        </div>
              ...
              <div>
                ...
                >
                  <div className="max-w-[670px] w-full">
                    ...
                    <p className="mb-6">
                      Official quality football gear, built for match day. Our
                      jerseys feature breathable quick-dry fabric, stitched
                      badges and a proper player fit, while boots and training
                      gear are selected for real turf and indoor use.
                    </p>
                    <p className="mb-6">
                      Every product can be tried on at any of our three Karachi
                      branches — Gulshan-e-Iqbal, Defense Badar Commercial and
                      Light House. If you can&apos;t find it here, you won&apos;t
                      find it anywhere in Karachi.
                    </p>
                    <p>
                      Free name & number stitching on jerseys, plus nationwide
                      delivery to every city in Pakistan.
                    </p>
                  </div>
                  ...
                  <div className="max-w-[447px] w-full">
                    ...
                    <p className="mb-6">
                      Wash jerseys and kits inside-out in cold water and air dry
                      to keep prints and numbers looking new for longer.
                    </p>
                    <p>
                      Clean boots and grippers after every match and store them
                      in a dry place to keep the grip and studs in top shape.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    ...
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        Quick-dry polyester (jerseys) / synthetic leather
                        (boots)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    <div className="max-w-[450px] min-w-[140px] w-full">
                      <p className="text-sm sm:text-base text-dark">
                        Name & Number Stitching
                      </p>
                    </div>
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        Free — available in-store or on delivery
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    ...
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        All over Pakistan — 2 to 4 working days
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                    ...
                    <div className="w-full">
                      <p className="text-sm sm:text-base text-dark">
                        Gulshan-e-Iqbal, Defense Badar Commercial, Light House
                      </p>
                    </div>
                  </div>
                </div>
