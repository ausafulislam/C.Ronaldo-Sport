...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Jerseys & Kits", value: "1" },
    { label: "Football Shoes", value: "2" },
    { label: "Footballs", value: "3" },
    { label: "Kids Uniforms", value: "4" },
    { label: "Grippers", value: "5" },
    { label: "Training Gear", value: "6" },
