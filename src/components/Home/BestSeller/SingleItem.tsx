...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-white shadow-1 min-h-[403px]">
        <div className="text-center px-4 py-7.5">
          ...
          <span className="flex items-center justify-center gap-2 font-medium text-lg">
            <span className="text-dark">Rs. {item.discountedPrice.toLocaleString("en-PK")}</span>
            <span className="text-dark-4 line-through">Rs. {item.price.toLocaleString("en-PK")}</span>
          </span>
        </div>

        <div className="flex justify-center items-center w-full h-[280px] px-4">
          <Image src={item.imgs.previews[0]} alt="" width={280} height={280} className="w-full h-full object-contain" />
        </div>
